...
// ========================================
// SCRIPT PARA VÍDEO DE FUNDO FUNCIONAR EM MOBILE
// ========================================
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  if (video) {
    ...
    // Força o vídeo a carregar em mobile
    ...
    const playVideo = () => {
      video.play()
        ...
        .catch(error => {
          ...
          // Se o vídeo não funcionar, aplica a classe de fallback
...
// Se for mobile e quiser forçar o uso de imagem ao invés do vídeo
if (isMobileDevice()) {
  document.addEventListener('DOMContentLoaded', function() {
...
// Seleciona o vídeo na seção #hero
const video = document.querySelector('#hero video');

// Define a velocidade inicial do vídeo para 0.5 (metade da velocidade normal)
video.playbackRate = 0.5; // 0.5x significa metade da velocidade normal

// Função para alterar a velocidade do vídeo
function setVideoSpeed(speed) {
  video.playbackRate = speed;
  console.log(`Velocidade do vídeo alterada para: ${speed}x`);
}

// Exemplo: Ajustar velocidades automaticamente (se desejado)
document.addEventListener('DOMContentLoaded', () => {
  // Não há necessidade de setTimeout, já que queremos começar com 0.5x
  // Você pode adicionar ajustes automáticos após o carregamento, se necessário
});
